 ...
 * @license     MIT
 */
class RelationshipHasOneTest extends PHPUnit_Framework_TestCase {
	...
	public function provideRelationships()
	{
		...
		$data[] = array(
			new Relationship_HasOne('test', array(
				'accessor' => TRUE,
			)),
			array(
				'name'     => 'test',
		...
		$data[] = array(
			new Relationship_HasOne('test_diff', array(
				'accessor' => FALSE,
			)),
			array(
				'name'     => 'test_diff',
